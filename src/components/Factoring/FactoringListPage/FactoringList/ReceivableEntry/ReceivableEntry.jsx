...
const ReceivableEntry = ({ transaction }) => {
  return (
    <>
      <tr className="TransactionEntry primary-border">
        <td className="text-left" colSpan="2">
          <Translation>
            {(t) => <span className="secondary-font">{t('ReceivableEntry.date')}:&nbsp;</span>}
          </Translation>
      ...
      <tr className="TransactionEntry text-center hard-border">
        <td>
          <p className="secondary-font mb-2">
            <Translation>{(t) => t('ReceivableEntry.invoices')}</Translation>
          </p>
        ...
        <td>
          <p className="secondary-font mb-2">
            <Translation>{(t) => t('ReceivableEntry.factoredAmount')}</Translation>
          </p>

          <p className="text-primary mb-0">
            {localizeNumber(formatNumber(transaction.total - transaction.remainder))}
          </p>
        </td>
      </tr>
    </>
